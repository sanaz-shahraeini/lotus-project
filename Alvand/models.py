...
class Device(models.Model):
    ...
    cable_type = models.CharField(max_length=100, blank=True, null=True, choices=CABLE_TYPES)
    created_at = models.DateTimeField(blank=True, null=True)
    updated_at = models.DateTimeField(blank=True, null=True)
...
class Permissions(models.Model):
    ...
    exts_label = ArrayField(models.CharField(max_length=200), blank=True, null=True)
...
class Records(models.Model):
    ...
    transferring = ArrayField(models.CharField(max_length=200), blank=True, null=True)
    created_at = models.DateTimeField(default=timezone.now)
    updated_at = models.DateTimeField(blank=True, null=True)
...
class Users(models.Model):
    ...
    usersextension = ArrayField(models.CharField(max_length=200), verbose_name="دسترسی های داخلی:", blank=True, null=True)
